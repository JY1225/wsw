 ...
 * 修改/完善：YouAreStupid
 */
public class JTimeChooserTextField extends JTextField{
    ...
    public JTimeChooserTextField() {
        this(getNowDate());
    }
 
    public JTimeChooserTextField(String dateString) {
        this();
    ...
    public JTimeChooserTextField(SimpleDateFormat df, String dateString) {
        this();
    ...
    public JTimeChooserTextField(Date date) {
        this("", date);
        //记忆原始日期时间
        initOriginalText(date);
    }
 
    public JTimeChooserTextField(String preLabel, Date date) {
        if (preLabel != null) {
    ...
    private class DateChooser extends JPanel implements ChangeListener{
            ...
            for (int i = 0; i < 6; i++) {
                for (int j = 0; j < 7; j++) {
                    ...
                    numberLabel.addMouseListener(new MouseAdapter() {
						@Override
						public void mouseEntered(MouseEvent mouseevent) {//鼠标变成手型
        ...
        void showDateChooser(Point position) {
            Frame owner = (Frame) SwingUtilities.getWindowAncestor(JTimeChooserTextField.this);
    ...
    public static void main(String[] args) {
        ...
        mainFrame.add(new JTimeChooserTextField(), java.awt.BorderLayout.CENTER);
