...
public class JDateChooserTextField extends JTextField{
    ...
    private class DateChooser extends JPanel implements ChangeListener{
        ...
        private JPanel createYearAndMonthPanal() {
            ...
            yearSpin.setFont(new Font("宋体", Font.PLAIN, 20));
            ...
            monthSpin.setFont(new Font("宋体", Font.BOLD, 20));
            ...
            daySpin.setFont(new Font("宋体", Font.BOLD, 20));
            daySpin.setName("Day");
        ...
        private JPanel createWeekAndDayPanal() {
            ...
            for (int i = 0; i < 7; i++) {
                ...
                cell.setFont(new Font("宋体", Font.PLAIN, 20));
